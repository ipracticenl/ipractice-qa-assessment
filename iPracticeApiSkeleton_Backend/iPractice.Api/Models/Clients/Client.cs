...
public class Client : Entity
{
    ...
    public void AssignNewPsychologist(long psychologistId) => PsychologistAssignment.AssignNewPsychologist(psychologistId);

    public Appointment BookAppointment(TimeRange timeSlot, long psychologistId, string? comment = null)
    {
        return Calendar.BookAppointment(timeSlot, psychologistId, comment);
    }
